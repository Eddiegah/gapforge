        ...
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #1a1a1a; color: #f5f5f5; border-radius: 8px;">
            <div style="display: flex; align-items: center; margin-bottom: 24px;">
              <span style="font-size: 24px; font-weight: 700; color: #FF5757;">GapForge</span>
            </div>
            ...
            <a href="${process.env.NEXT_PUBLIC_APP_URL}/gap-drops" style="display: inline-block; padding: 12px 24px; background: #FF5757; color: white; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 15px;">
