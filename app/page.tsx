...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. The free plan gives you 5 Gap AI searches per month, access to public Gap Drops, and GapSimplify for up to 3 papers. Pro and Team plans unlock unlimited searches, personalized drops, workspaces, and API access.",
  },
];
...
const PLANS = [
  {
    ...
    features: [
      "5 Gap AI searches/month",
      "Public weekly Gap Drops",
      "3 GapSimplify papers/month",
      "Save up to 10 gaps",
    ],
  ...
  },
  {
    ...
    features: [
      "Unlimited Gap AI searches",
      "Personalized weekly Gap Drops",
      "Unlimited GapSimplify",
